...
Download the analysis files `nematode_ITS2_database_version1.fasta`,  `nematode_taxonomy.tax` and `batchfile.txt` from the [downloads](examples.html#Dowloads) section. Place these files in the folder that contains your sequencing data (i.e. 'MiSeq_Run')
