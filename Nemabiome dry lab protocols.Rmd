---
title: "Nemabiome dry lab protocols"
author: "Russell Avramenko"
...
# **Overview of dry lab protocols for Nemabiome sequencing** {#anchor}

#### 1. Downloading Analysis Software
#### 2. Preparing sequencing files for analysis
#### 3. Downloading Analysis Files
#### 4. Running Analysis
#### 5. Data Analysis


### **Nemabiome Data Analysis:**

Once you have generated the data from the MiSeq you must complete the following steps in order to analyze the data.


# **1. Downloading Analysis Software** {#anchor}
...
To download Mothur go to www.mothur.org, click “Download” and download the latest version. This will download a single folder. You must move this folder to your home directory (your C: Drive on a PC, or your ‘User’ folder on a Mac)

Tip: To check that you have placed the folder in the correct location, open up either Terminal (Mac) or Command Prompt (PC). Type ```~/mothur/mothur``` (Mac) or ```C:\mothur\mothur.exe``` (PC). If your screen looks similar to this:

You have done it correctly.

# **2. Preparing files for analysis**
## **2.1 Downloading sequencing data files from BaseSpace**
...
Recommendation: Create a folder on your home directory with the name of your sequencing run (for the rest of this example it will be called “MiSeq_Run”). Move all of your files into this folder.
...
```sample1	sample1_ S1_L001_R1_001.fastq	 sample1_S1_L001_R2_001.fastq```
```sample2	sample2_ S2_L001_R1_001.fastq	 sample2_S2_L001_R2_001.fastq```
```sample3	sample3_ S3_L001_R1_001.fastq	 sample3_S3_L001_R2_001.fastq```
```.......```
